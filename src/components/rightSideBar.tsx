...
export default function RightSideBar(props:rightSideBarProps) {
    ...
    return(
        <div style={{height:'100vh', width:'25vw', backgroundColor: `var(--Dark_Grey_50)`}}>
                            ...
                            <div className={rightBar.inputContainer} id="bottomTab">
                                {
                                    queryMode == 'document' && responseError[0] ? (
                                        <p className={rightBar.errorText}>Oops! Something went wrong while generating a response.<br/>Please try again.</p>
                                        // Button if you need to have it, look at responseError
                                    ) : queryMode == 'web' && responseError[1] ? (
                                        <p className={rightBar.errorText}>Oops! Something went wrong while generating a response.<br/>Please try again.</p>                                        // Button if you need to have it, look at responseError
                                        // Button if you need to have it, look at responseError
                                    ) : (null)
                                }
